...
const Portfolio = memo(function Portfolio() {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      description: "A comprehensive desktop application designed for modern retail businesses. Integrating Point of Sale (POS), attendance tracking, payroll management, and inventory control into a single powerful platform.",
      features: [
        "Point of Sales (POS)",
        "Attendance System",
        "Payroll Management",
    ...
    },
    {
      ...
      description: "A streamlined ERP system designed for small businesses, focusing on core operations. Simplify management of sales, purchasing, financial reporting, and payroll in one intuitive platform.",
      features: [
        "Sales Management",
        "Purchase Orders",
    ...
    },
    {
      ...
      description: "Comprehensive management platform for Universitas Terbuka Service Centers (Salut). Facilitating student administration, semester tuition payments, and academic support services.",
      features: [
        "Student Management",
        "Tuition Payments",
    ...
    },
    {
      ...
      description: "Mobile-first Human Resource Information System (HRIS) designed for modern workforce management. Streamlining employee attendance, payroll processing, and leave management in one easy-to-use app.",
      features: [
        "GPS Attendance",
        "Payroll Slips",
        "Leave Management",
    ...
    },
    {
      ...
      description: "A comprehensive school management platform tailored for Indonesian educational institutions. Streamlining academic administration, student records, teacher management, and financial operations.",
      features: [
        "Student Information",
        "Academic Management",
        "Teacher Portal",
